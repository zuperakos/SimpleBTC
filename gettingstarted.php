...
<b><u>Advanced Windows & Linux (for best mining results)</u></b><br/>
	...
	Run cgminer: cgminer -o http://<?php echo $poolname ?>:<?php echo $poolport ?> -u username.1 -p x<br/>
	Run cgminer for max performance: cgminer -o http://<?php echo $poolname ?>:<?php echo $poolport ?> -u username.1 -p x -I 8<br/><br/>
	...
	Server: Other<br />
	Host: <?php echo $poolname ?><br />
	Port: <?php echo $poolport ?><br />
	...
	Run hashkill: hashkill-gpu -p bitcoin minername:password:<?php echo $poolname ?>:<?php echo $poolport ?>
