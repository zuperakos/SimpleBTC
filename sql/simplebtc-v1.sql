...
/*
-- Query: SELECT * FROM simplecoin.settings
LIMIT 0, 1000

-- Date: 2013-04-18 01:04
*/
INSERT INTO `settings` (`setting`,`value`) VALUES ('sitepercent','2');
INSERT INTO `settings` (`setting`,`value`) VALUES ('sitetxfee','0');
INSERT INTO `settings` (`setting`,`value`) VALUES ('siterewardtype','0');
INSERT INTO `settings` (`setting`,`value`) VALUES ('sitepayoutaddress','');
INSERT INTO `settings` (`setting`,`value`) VALUES ('pagetitle','domain.com');
INSERT INTO `settings` (`setting`,`value`) VALUES ('websitename','Site Name');
INSERT INTO `settings` (`setting`,`value`) VALUES ('slogan','Site Slogan');
